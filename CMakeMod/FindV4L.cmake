...
pkg_check_modules(PC_V4L QUIET libv4l2)
pkg_check_modules(PC_V4L_CONVERT QUIET libv4l2convert)

set(V4L_DEFINITIONS ${PC_V4L_CFLAGS_OTHER})

find_path(V4L_INCLUDE_DIR libv4l2.h libv4lconvert.h
          HINTS ${PC_V4L_INCLUDE_DIRS} ${PC_V4L_CONVERT_INCLUDE_DIRS}
          PATH_SUFFIXES libv4l )

find_library(V4L_LIBRARY NAMES v4l2
             HINTS ${PC_V4L_LIBRARY_DIRS} )
find_library(V4LCONVERT_LIBRARY NAMES v4lconvert
             HINTS ${PC_V4L_CONVERT_LIBRARY_DIRS} )
